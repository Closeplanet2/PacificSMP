...
@PulseAutoRegister
public class SpeedDolphinRecipe implements PulseRecipe {
    private static final CustomItem CUSTOM_ITEM = CustomItem.SpeedDolphin;
    ...
    public HashMap<Character, RecipeChoice> recipeMaterials() {
        ...
        hashmap.put('W', new RecipeChoice.MaterialChoice(Material.RABBIT_FOOT));
        hashmap.put('E', new RecipeChoice.MaterialChoice(Material.PRISMARINE_CRYSTALS));
        hashmap.put('R', new RecipeChoice.MaterialChoice(Material.DIAMOND_BOOTS));
        hashmap.put('T', new RecipeChoice.MaterialChoice(Material.HEART_OF_THE_SEA));
        return hashmap;
    }
}
