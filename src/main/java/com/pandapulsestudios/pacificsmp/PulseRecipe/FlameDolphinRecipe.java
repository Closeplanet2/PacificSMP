...
@PulseAutoRegister
public class FlameDolphinRecipe implements PulseRecipe {
    private static final CustomItem CUSTOM_ITEM = CustomItem.FlameDolphin;
    ...
    public HashMap<Character, RecipeChoice> recipeMaterials() {
        ...
        hashmap.put('W', new RecipeChoice.MaterialChoice(Material.GOLDEN_APPLE));
        hashmap.put('E', new RecipeChoice.MaterialChoice(Material.PRISMARINE_CRYSTALS));
        hashmap.put('R', new RecipeChoice.MaterialChoice(Material.BLAZE_ROD));
