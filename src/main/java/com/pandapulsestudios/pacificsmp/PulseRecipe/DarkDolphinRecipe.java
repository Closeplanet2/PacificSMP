...
@PulseAutoRegister
public class DarkDolphinRecipe implements PulseRecipe {
    private static final CustomItem CUSTOM_ITEM = CustomItem.DarkDolphin;
    ...
    public HashMap<Character, RecipeChoice> recipeMaterials() {
        ...
        hashmap.put('W', new RecipeChoice.MaterialChoice(Material.ECHO_SHARD));
        hashmap.put('E', new RecipeChoice.MaterialChoice(Material.PRISMARINE_CRYSTALS));
        hashmap.put('F', new RecipeChoice.MaterialChoice(Material.HEART_OF_THE_SEA));
        return hashmap;
    }
}
